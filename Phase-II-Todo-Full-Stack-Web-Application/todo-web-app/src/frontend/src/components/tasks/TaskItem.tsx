...
export default function TaskItem({ task, onToggleComplete, onDelete }: TaskItemProps) {
  return (
    <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 relative overflow-hidden"> {/* Darker background, more pronounced shadow, hover effect */}
      ...
      <button
        ...
        className="neon-button-red z-10" /* Applied neon-button-red directly */
      >
        <FaTrashAlt />
      </button>
    </div>
